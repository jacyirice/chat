...
class GroupUser(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE,verbose_name=_("user"), related_name="my_groups")
    group = models.ForeignKey("chat.Group", verbose_name=_("group"), on_delete=models.CASCADE)
class Message(models.Model):
    ...
    group = models.ForeignKey("chat.Group", related_name="messages", on_delete=models.CASCADE)
